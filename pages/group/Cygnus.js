...
import Json from "../../Json/cygnus/job.json";
console.log(Json)
...
const Cygnus = (props) => {
    ...
    const { soulMaster, mikhail, flameWizard, windBreaker, nightWalker, striker } = Json
    ...
    return (
        <div>
            ...
            <div className="character__wrap">
                <div className="character__bg bg__soulMaster"></div>
                <div className="character__bg bg__mikhail"></div>
                <div className="character__bg bg__flameWizard"></div>
                <div className="character__bg bg__windBreaker"></div>
                ...
                <div className="character__select flex-center">
                    ...
                    <div className="character__container">
                        <ul className="character d-flex">
                            <li onClick={() => setNum(0)} className="soulMaster"></li>
                            <li onClick={() => setNum(1)} className="mikhail"></li>
                            <li onClick={() => setNum(2)} className="flameWizard"></li>
                            <li onClick={() => setNum(3)} className="windBreaker"></li>      
                            <li onClick={() => setNum(4)} className="nightWalker"></li>
                            <li onClick={() => setNum(5)} className="striker"></li>
                        </ul>
                    </div>
