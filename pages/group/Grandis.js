    ...
    return (
        <div>
            ...
            <div className="character__wrap">
                <div className="character__bg bg__kaiser"></div>
                <div className="character__bg bg__cadena"></div>
                <div className="character__bg bg__angelicbuster"></div>
                <div className="character__bg bg__adele"></div>
                <div className="character__bg bg__illium"></div>
                ...
                <div className="character__select flex-center">
                    ...
                    <div className="character__container">
                        <ul className="character d-flex">
                            <li onClick={() => setNum(0)} className="kaiser"></li>
                            <li onClick={() => setNum(1)} className="cadena"></li>
                            <li onClick={() => setNum(2)} className="angelicbuster"></li>
                            <li onClick={() => setNum(3)} className="adele"></li>      
                            <li onClick={() => setNum(4)} className="illium"></li>
                            <li onClick={() => setNum(5)} className="ark"></li>
                            <li onClick={() => setNum(6)} className="hoyoung"></li>
                        </ul>
                    </div>
