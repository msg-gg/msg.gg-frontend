...
import Json from "../../Json/kinesis/job.json";
console.log(Json)
    ...
    return (
        <div>
            ...
            <div className="character__wrap">
                <div className="character__bg bg__kinesis"></div>
                <div className="character__rect"></div>
                <Sidebar title="group" group="kinesis"  />
                ...
                <div className="character__select flex-center">
                    ...
                    <div className="character__container">
                        <ul className="character flex-center">
                            <li onClick={() => setNum(0)} className="kinesis"></li>
                        </ul>
                    </div>
